...
W="/opt/fae-f2-runtime-r3"
L="/var/log/fae-f2-runtime-r3"
...
test -s "$SRC"
gcc -O2 -std=gnu11 -Wall -Wextra -I"$SDK_DIR/userspace/include" "$SRC" -o "$W/run_f2_parity" $LDFLAGS -lfpga_mgmt -lpthread > "$L/compile.log" 2>&1
