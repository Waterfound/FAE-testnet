...
}else if(['MTS_07_STRESS_ACTIVE','MTS_07_GREEN','MTS_08_STRESS_ACTIVE','MTS_08_GREEN','MTS_09_STRESS_ACTIVE','MTS_09_GREEN','MTS_10_BASELINE_ACTIVE'].includes(manifest.status)){
