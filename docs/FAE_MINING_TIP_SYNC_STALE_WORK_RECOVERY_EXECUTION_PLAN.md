...
Integration base revision: `aab16f58cec310781034b240c8321e533e45ca31`  
Branch: `colony/mining-tip-sync-plan-002`  
...
The run evidence was pinned at `f3561ec8bf53d25c646f2f4c880af506cc1f5a65`. Before integration, the default branch advanced to `aab16f58cec310781034b240c8321e533e45ca31` through Post-Quantum Lab-only files; comparison confirmed that `mining.js`, `core.js`, the v4 testnet backend, and `tests/client-smoke.mjs` were unchanged.
