...
Before PR creation, `main` advanced to `9e7b5925c2ca5d0dda93b228aaaa727308f8888f` with the cross-Lab canonical integration gate and MTS-12 preparation. The new integration workflow is read-only, uses no direct secrets and no `pull_request_target`. PSR-13 was rebound to the new main so clean-room and provenance evidence will be generated against the integrated tree rather than the stale predecessor.
