...
Source revision: `eb8409573e3ee4c37b925817a474a1c6e5dd4410`  
...
| Mining/templates/coordinator | MINING, AUTH, AUTHORITY, AVAIL | coordinator smoke; signed receipts; Mining Tip Sync Lab including MTS-04/06 stale-work cancellation evidence | PSR-09 |
...
Before PR creation, FAE `main` advanced from `83a6adff3a6232026e78321062fe58e68174d9cd` to `eb8409573e3ee4c37b925817a474a1c6e5dd4410`.
The intervening diff was reviewed. It affected the Mining Tip Sync/browser mining path and the corresponding Forge hash. The matrix therefore admits `lab/mining-tip-sync/tests/mts-04-06.test.mjs` as additional specialized evidence for AS-04 while preserving the distinction between specialized evidence and the universal canonical PR gate.
