...
3. executes 17 attacks mapped to attack surfaces and invariants;
...
Before PR creation, `main` advanced by eight commits to `30df85b754feb8dfcaade9b10e7dabce1dc06a6b` with MTS-12 top-level Safari acceptance work. The campaign was rebound and adds WB-17 for MTS-12 preflight/privacy/authority boundaries. This CI attack does not claim or synthesize the required physical iPad evidence.
